...
docker build -t energiai-ai-service-rl:latest .

3. Levantar el contenedor mapeando el puerto 8000

docker run -d -p 127.0.0.1:8001:8000 --name ai-service-rl-test energiai-ai-service-rl:latest

*Ver los logs de inicio:

docker logs --tail 20 ai-service-rl-test
